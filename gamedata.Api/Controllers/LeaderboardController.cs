...
namespace Leaderboard.Controllers
{
    ...
    public class LeaderboardController : ControllerBase
    {
        ...
        [HttpGet]
        public ActionResult<List<LeaderboardScore>> GetAll(int count, bool allowDuplicatesUsers = false, string? gameVersion = null)
        {
            if (count <= 0)
            ...
            var scores = ScoreService.GetAll(count, allowDuplicatesUsers, gameVersion);
